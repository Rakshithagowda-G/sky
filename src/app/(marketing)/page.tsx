...
const HomePage = () => {
    ...
    return (
        <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
            ...
            {/* hero */}
            <Hero 
                title="Build your next idea and ship your dream site"
                subtitle="Zero code, maximum speed. Make professional sites easy, fast and fun while delivering best-in-class SEO, performance."
                eyebrow="Introducing Skyneski"
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            Skyneski offers a range of features to help you build a stunning website in no time
                        </p>
                    </div>
                </Container>
                <Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <div className="hidden md:block absolute bottom-0 -left-1/3 w-72 h-72 bg-indigo-600 rounded-full blur-[10rem] -z-10"></div>
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center mb-8">
                        <SectionBadge title="Solutions" />
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Our IT Solutions
                        </h2>
                        <p className="text-muted-foreground mt-6">
