...
export default function AboutUsSection() {
  ...
  const services = [
    {
      ...
      secondaryIcon: <Sparkles className="w-4 h-4 absolute -top-1 -right-1 text-primary/60" />,
      title: "Development",
      description:
        "Build powerful, scalable applications with our expert development team. We leverage cutting-edge technologies to create solutions that drive your business forward.",
      position: "left",
    },
    {
      icon: <Zap className="w-6 h-6" />,
      secondaryIcon: <CheckCircle className="w-4 h-4 absolute -top-1 -right-1 text-primary/60" />,
      title: "Performance",
      description:
        "Optimize your platform for lightning-fast performance. Our solutions ensure seamless user experiences with minimal load times and maximum efficiency.",
      position: "left",
    },
    {
      icon: <Palette className="w-6 h-6" />,
      secondaryIcon: <Star className="w-4 h-4 absolute -top-1 -right-1 text-primary/60" />,
      title: "Design",
      description:
        "Create stunning, intuitive interfaces that users love. Our design process combines aesthetics with functionality to deliver exceptional digital experiences.",
      position: "left",
    },
    {
      ...
      title: "Integration",
      description:
        "Seamlessly connect your systems with our integration services. We ensure all your tools work together harmoniously for maximum productivity.",
      position: "right",
    },
    {
      ...
      title: "Deployment",
      description:
        "Launch your projects with confidence. Our deployment process ensures smooth rollouts with zero downtime and comprehensive monitoring.",
      position: "right",
    },
    {
      ...
      title: "Solutions",
      description:
        "Deliver comprehensive software solutions tailored to your needs. From concept to completion, we handle every aspect of your digital transformation.",
      position: "right",
    },
  ]
  ...
  const stats = [
    ...
    { icon: <Users />, value: 2500, label: "Happy Clients", suffix: "+" },
  ...
  return (
    <section
      id="about-section"
      ref={sectionRef}
      className="w-full py-24 px-4 bg-gradient-to-b from-background via-background/95 to-muted/30 text-foreground overflow-hidden relative"
    >
      ...
      >
        ...
        <motion.p className="text-center max-w-2xl mx-auto mb-16 text-muted-foreground" variants={itemVariants}>
          We are a passionate team of developers and designers dedicated to creating innovative digital solutions that
          transform businesses. With cutting-edge technology and commitment to excellence, we turn your vision into
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="flex justify-center items-center order-first md:order-none mb-8 md:mb-0">
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=2874&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              ...
              ></motion.div>
              <motion.div
                className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-primary/60"
                animate={{
                  y: [0, 10, 0],
                  opacity: [0.5, 1, 0.5],
                }}
